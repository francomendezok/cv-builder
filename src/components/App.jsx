...
export default function App() {
  ...
  const InfoExample = 
    {
      ...
      skills: {
        skill: 'HTML, CSS, JavaScript, TailwindCSS, React'
      }
    }
  ...
  return (
    <div className="container">
      <CreateResume updateLayout={updateLayout} updateColor={updateColor} updateFonts={updateFonts} color={color} updateExample={updateExample} example={example}/>
