...
function ResumeInfo({ info, visible }) {
    ...
    return (
      <div className={"resumeInfo h-full flex justify-around"}>
        ...
        <div className="mainInfoCV w-2/3">
...
function Skills({skills}) {
    return (
      <div className="skillsDiv w-4/5 m-auto">
...
export default function Resume ({layout, color, fonts, info, visible}) {
  ...
  const skills = allEmptySkills ? 'hidden' : ''
    ...
    return (
         <aside id={layout} style={{ fontFamily: fonts, fontSize: '1rem' }} className="resume bg-slate-100 shadow-xl">
            <div className="personalInfo p-6" style={{ background: color, color: invertedColor }}>
                ...
                <div className="personalDiv flex justify-around">
                  <span className="personalInfoDetails flex justify-evenly">
